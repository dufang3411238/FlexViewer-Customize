...
import com.esri.viewer.skins.CustomContentNavi;
/**
...
*/
        ...
        */
		cssStyleDeclarationInfoContainer.setStyle("borderSkin",null);
	/*	cssStyleDeclarationInfoContainer.setStyle("infoOffsetX",-45);*/
		cssStyleDeclarationInfoContainer.setStyle("infoPlacement","none");
		cssStyleDeclarationInfoContainer.setStyle("backgroundColor", 0xffffff);
		cssStyleDeclarationInfoContainer.setStyle("borderThickness", 1);
		cssStyleDeclarationInfoContainer.setStyle("borderColor", 0xd2d2d2);
		cssStyleDeclarationInfoContainer.setStyle("contentBackgroundAlpha", 1);
		cssStyleDeclarationInfoContainer.setStyle("backgroundAlpha", 1);
		
/*        if (numberOfStyleColors > 4)
        {
			//cssStyleDeclarationInfoContainer.setStyle("backgroundColor", backgroundColor); 
			//修改Infowindow 背景颜色  by tinytoy
            cssStyleDeclarationInfoContainer.setStyle("backgroundColor", backgroundColor);
...
*/
        ...
        cssStyleDeclarationContentNavigator.setStyle("headerBackgroundColor", 0x59aeec);
	
       
		
		/*cssStyleDeclarationContentNavigator.setStyle("headerBackgroundAlpha", styleAlpha);
		cssStyleDeclarationContentNavigator.setStyle("visible",false);*/
		//modify by tinytoy
		//var cssStyleDeclarationContentNavigatorPreviousButton:CSSStyleDeclaration = topLevelStyleManager.getStyleDeclaration("com.esri.ags.components.ContentNavigator|previousButton");
		//cssStyleDeclarationContentNavigatorPreviousButton.setStyle("visible",false);
/*
