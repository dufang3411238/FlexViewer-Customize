...
import com.esri.viewer.tdtMapslayer;
import com.esri.viewer.TianDiTuLayerMercator;
...
public class LayerCreator
{
    ...
    private static function createLayer(layerCreationProperties:LayerCreationProperties):Layer
    {
		...
		else if (layerType == "tdtmap")
		{
			return createtdtLayer(layerCreationProperties);
		}
		else if (layerType == "tdtmapmer")
		{
			return createtdtmerLayer(layerCreationProperties);
		}
        else
        {
	...
	private static function createtdtmerLayer(layerCreationProperties:LayerCreationProperties):TianDiTuLayerMercator
	{
		var tdtLayer:TianDiTuLayerMercator=new TianDiTuLayerMercator(layerCreationProperties.style);
	...
	private static function createtdtLayer(layerCreationProperties:LayerCreationProperties):tdtMapslayer
	{
		var tdtLayer:tdtMapslayer=new tdtMapslayer(layerCreationProperties.style);
		tdtLayer.name=layerCreationProperties.label;
